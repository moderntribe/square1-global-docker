...
class AppServiceProvider extends ServiceProvider {
	...
	public function register(): void {
		...
		$this->app->bind( ReaderInterface::class, Json::class );

		$this->app->bind( WriterInterface::class, \Laminas\Config\Writer\Json::class );
		...
		$this->app->bind( 'App\Contracts\Runner', 'App\Runners\CommandRunner' );

		$this->app->bind( 'App\Contracts\File', 'App\Services\FileIO' );
		...
		$this->app->when( Ca::class )
				  ...
				  ->give( static function ( Application $app ) {
					  /** @var \App\Services\OperatingSystem $os */
