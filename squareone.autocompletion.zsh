...
_so()
{
    ...
    case $state in
        ...
        option)
            ...
            export-test-db)
            opts+=("--output-path:Where to export the database in the docker container" "--container:The docker container to use")
            ;;
